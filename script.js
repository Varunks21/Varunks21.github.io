document.addEventListener('DOMContentLoaded', () => {
    ...
    brochureButton.addEventListener('click', (e) => {
        ...
        // Array of PDF files to download
        const pdfFiles = [
            { name: 'brochure1.pdf', displayName: 'CustomizedTechnologies_Brochure1.pdf' },
            { name: 'brochure2.pdf', displayName: 'CustomizedTechnologies_Brochure2.pdf' },
            { name: 'brochure3.pdf', displayName: 'CustomizedTechnologies_Brochure3.pdf' },
            { name: 'brochure4.pdf', displayName: 'CustomizedTechnologies_Brochure4.pdf' }
        ];
